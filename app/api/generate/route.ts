...
export async function POST(req: Request) {
    try {
        ...
        const imageUrl = `https://api.dicebear.com/9.x/shapes/png?seed=${seed}&backgroundColor=1e1e2e,2d2d44,0f172a&shape1Color=f472b6,c084fc,818cf8&shape2Color=fbbf24,34d399,22d3ee&shape3Color=f87171,fb923c,facc15`;
