                                    ...
                                    <div className="bg-surface-1 border border-border-default rounded-2xl p-6 shadow-sm">
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <Button
                                                ...
                                                onClick={async () => {
                                                    const themes = ["Cyberpunk City", "Abstract Waves", "Retro Pixel", "Ethereal Dream", "Neon Samurai", "Space Odyssey"];
                                                    const randomTheme = themes[Math.floor(Math.random() * themes.length)];
                                                    ...
                                                    try {
                                                        const res = await fetch('/api/generate', {
                                                            method: 'POST',
                                                            headers: { 'Content-Type': 'application/json' },
                                                            body: JSON.stringify({ prompt: randomTheme + " nft art" })
                                                        });
                                                        const data = await res.json();
                                                        ...
                                                        if (btn) btn.innerText = "✨ AI Generate";
                                                    }
                                                }}
                                                id="magic-btn"
                                            >
